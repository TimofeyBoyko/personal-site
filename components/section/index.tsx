...
function Section({ id, headerName, isLast, children }: SectionProps) {
  return (
    ...
    >
      <div className="sticky top-0 z-20 -mx-6 mb-4 w-full bg-slate-900/75 px-6 py-5 backdrop-blur tablet:sr-only tablet:relative tablet:top-auto tablet:mx-auto tablet:w-full tablet:px-0 tablet:py-0 tablet:opacity-0">
